...
//   current: `
//   <h3>Babylon Arts: Small but Perfect </h3>
//   <p>On until the 22nd December , all of my peices are for sale for £60</p>
//   <img class="current" src="../current/1.jpg" alt="">
//   <img class="current" src="../current/5.jpg" alt="">
//   <img class="current" src="../current/2.jpg" alt="">
//   <img class="current" src="../current/6.jpg" alt="">
//   <img class="current" src="../current/3.jpg" alt="">
//   <img class="current" src="../current/8.jpg" alt="">
//   <img class="current" src="../current/7.jpg" alt="">
//   `,
// };
...
<a href="https://www.library.live/the-library-presents-events/cecilyandsalty-bzc8z-a5kc3-dpayk-8tg2j-tx84f" target="_blank" class="link-reference">To book follow this link</a>
</p>
  `,
};

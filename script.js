...
const contentData = {
  ...
  <br>
  <h4>Fitzwilliam Museum - February 2024 </h4>
  <p>
  ...
  <button class="toggleButton">Pictures</button>
  <div class="imageContainer">
  <img class="fitz-2023" src="../2023-fitz/1.png" alt="">
  <img class="fitz-2023" src="../2023-fitz/2.png" alt="">
  <img class="fitz-2023" src="../2023-fitz/3.png" alt="">
  </div>
  <br>
    </section>
    <br>
    <h4>Ely Museum - November 2023 </h4>
    <p>At Ely Museum, we hosted a pop-up workshop where visitors could drop in and create holiday cards using printmaking techniques. Participants experimented with styrofoam printing to design unique, festive cards, enjoying a hands-on and creative activity that celebrated the holiday spirit.</p>
    <button class="toggleButton">Pictures</button>
    <div class="imageContainer">
    <img class="ely-museum" src="../ely-museam/7.png" alt="">
    <img class="ely-museum" src="../ely-museam/2.png" alt="">
    <img class="ely-museum" src="../ely-museam/8.png" alt="">
    </div>
    <br>
    <h4>Ely Market - August 2023</h4>
    <p>The workshops, titled Picture Me, Ely, focused on self-portraits as a means of creative self-expression. Held on the 12th and 19th, each session was led by volunteers specializing in different artistic techniques such as collage, painting, and printing. Participants were guided to create unique self-portraits within these mediums, celebrating their individuality and connection to Ely. Preparations included volunteers developing mock-ups of their chosen styles, with collaborative planning meetings ensuring a cohesive and engaging experience for everyone involved.
    </p>
    <button class="toggleButton">Pictures</button>
    <div class="imageContainer">
    <img class="ely-market" src="../ely-market/1.png" alt="">
    <img class="ely-market" src="../ely-market/2.png" alt="">
    // <img class="ely-market" src="../ely-market/3.png" alt="">
    </div>
    <br>
    <h4>Fermynwoods - February 2023 </h4>
    <p>
